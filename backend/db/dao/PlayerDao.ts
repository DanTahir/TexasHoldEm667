...
export async function getPlayerByUserAndLobbyId(user_id: String, game_lobby_id: String): Promise<Player> {
...
export async function removePlayerByUserAndLobbyId(user_id: String, game_lobby_id: String) {
...
export async function updateCards(player_id: String, card_1: String, card_2: String) {
